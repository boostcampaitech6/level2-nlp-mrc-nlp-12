...
def parse_arguments() :
    ...
    parser.add_argument('--eval_retrieval', type=bool, default=True)
    ...
    parser.add_argument('--output_dir', type=str, default="./models/train_dataset")
...
def main():
    ...
    if args.do_train or args.do_eval:
        run_mrc(training_args, datasets, tokenizer, model, args)
...
def run_mrc(
    ...
    last_checkpoint, max_seq_length = check_no_error(
        training_args, datasets, tokenizer, args.max_seq_length,
    )
    ...
    # Post-processing:
    def post_processing_function(examples, features, predictions, args):
    ...
    trainer = QuestionAnsweringTrainer(
        ...
        eval_examples=datasets["validation"] if args.do_eval else None,
        tokenizer=tokenizer,
